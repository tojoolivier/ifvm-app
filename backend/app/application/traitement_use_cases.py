...
def _construire_traitement_base(
    *,
    ...
    traitement = Traitement(
        ...
        longitude=longitude,
        altitude=altitude,
        nb_agents_permanents=nb_agents_permanents,
        nb_agents_temporaires=nb_agents_temporaires,
        nb_personnel_local=nb_personnel_local,
        moyens_atomiseur_nb=moyens_atomiseur_nb,
        moyens_essence_litres=moyens_essence_litres,
        moyens_disque_rotatif_nb=moyens_disque_rotatif_nb,
        moyens_piles_nb=moyens_piles_nb,
        moyens_ulvamast_nb=moyens_ulvamast_nb,
...
class CreateTraitementTerrestre:
    ...
    async def execute(
        ...
        terrestre = TraitementTerrestre(
            ...
            agent_encadreur=agent_encadreur,
            consultant_international=consultant_international,
            surface_atomiseur_ha=surface_atomiseur_ha,
            surface_disque_rotatif_ha=surface_disque_rotatif_ha,
            surface_atomiseur_autoporte_ha=surface_atomiseur_autoporte_ha,
            ...
            nb_piles=nb_piles,
            pesticide_unite=pesticide_unite,
            pesticide_recu_l=pesticide_recu_l,
