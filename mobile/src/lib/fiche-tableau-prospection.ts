// Grilles de la fiche de prospection en tableaux — mêmes constantes et mêmes règles de sélection
// que `backend/app/presentation/prospection_pdf.py` (formulaires papier intensif et extensif) et
// que `frontend/src/lib/fiche-tableau-prospection.ts`.
...
export function enListe(valeur: unknown): string[] {
