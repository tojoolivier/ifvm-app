...
const styles = StyleSheet.create({
  ...
  actuelEtiquette: { fontSize: 10, fontWeight: '700', letterSpacing: 0.5, color: EQ.attenue },
  actuelNom: { fontSize: 14, fontWeight: '700', color: EQ.encre },
  actuelCoord: { fontSize: 11.5, fontWeight: '500', fontFamily: Fonts.mono, color: EQ.etiquette },
  vol: { gap: 6, padding: 9, borderRadius: 13, borderWidth: 1, borderColor: EQ.ambreBordure, backgroundColor: EQ.ambreFond },
  volTitre: { fontSize: 10, fontWeight: '700', letterSpacing: 0.4, color: EQ.ambre },
  volHeures: { flexDirection: 'row', gap: 12 },
  volHeure: { flex: 1, gap: 3 },
  volEtiquette: { fontSize: 10.5, fontWeight: '600', color: EQ.attenue },
