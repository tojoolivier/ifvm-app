...
const styles = StyleSheet.create({
  ...
  loupe: { fontSize: 13, lineHeight: 16, color: EQ.etiquette },
  rechercheSaisie: { flex: 1, fontSize: 12.5, fontWeight: '500', color: EQ.encre, padding: 0 },
  vide: { padding: 12, fontSize: 12, lineHeight: 15, fontWeight: '500', color: EQ.etiquette },
  ...
  immat: { marginLeft: 'auto', fontSize: 10.5, lineHeight: 13, fontWeight: '600', fontFamily: Fonts.mono, color: EQ.etiquette },
  nom: { marginTop: 3, fontSize: 15, lineHeight: 19, fontWeight: '700', color: EQ.encre },
  coord: { marginTop: -3, fontSize: 11.5, lineHeight: 14, fontWeight: '500', fontFamily: Fonts.mono, color: EQ.attenue },
  depuis: { marginTop: -2, fontSize: 11.5, lineHeight: 14, fontWeight: '500', color: EQ.attenue },
  dependant: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
  ...
  branche: { fontSize: 12, lineHeight: 15, color: EQ.etiquette },
  dependantTexte: { flex: 1, gap: 1 },
  dependantNom: { fontSize: 12.5, lineHeight: 16, fontWeight: '600', color: EQ.encre },
  dependantCoord: { fontSize: 10.5, lineHeight: 13, fontWeight: '500', fontFamily: Fonts.mono, color: EQ.etiquette },
  dependantDroite: { alignItems: 'flex-end', gap: 4 },
  deplacer: { fontSize: 11.5, lineHeight: 14, fontWeight: '700', color: EQ.vert },
  historique: { gap: 4, marginTop: 6, paddingTop: 7, borderTopWidth: 1, borderTopColor: EQ.separateur },
  historiqueTitre: { fontSize: 10, lineHeight: 12, fontWeight: '700', letterSpacing: 0.5, color: EQ.attenue },
  historiqueLigne: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  puce: { width: 7, height: 7, borderRadius: 4, backgroundColor: EQ.vert },
  historiqueTexte: { fontSize: 11.5, lineHeight: 14, fontWeight: '500', color: EQ.attenue },
  deplacerBouton: {
    height: 38,
    borderRadius: 10,
    borderWidth: 1,
  ...
  deplacerBoutonTexte: { fontSize: 12.5, lineHeight: 16, fontWeight: '700', color: EQ.vert },
});
