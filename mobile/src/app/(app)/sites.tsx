...
const styles = StyleSheet.create({
  ...
  nom: { marginTop: 3, fontSize: 14, fontWeight: '700', color: EQ.encre },
  coord: { marginTop: -3, fontSize: 10, fontWeight: '500', fontFamily: Fonts.mono, color: EQ.attenue },
  depuis: { marginTop: -2, fontSize: 10, fontWeight: '500', color: EQ.attenue },
  dependant: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
