...
const styles = StyleSheet.create({
  ...
  loupe: { fontSize: 12, color: EQ.etiquette },
  rechercheSaisie: { flex: 1, fontSize: 11, fontWeight: '500', color: EQ.encre, padding: 0 },
  vide: { padding: 12, fontSize: 11, fontWeight: '500', color: EQ.etiquette },
  principal: { gap: 4, padding: 9, borderRadius: 13, borderWidth: 1.5, borderColor: EQ.vert, backgroundColor: EQ.carte },
  tete: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  immat: { marginLeft: 'auto', fontSize: 9, fontWeight: '600', fontFamily: Fonts.mono, color: EQ.etiquette },
  nom: { marginTop: 6, fontSize: 14, fontWeight: '700', color: EQ.encre },
  coord: { fontSize: 10, fontWeight: '500', fontFamily: Fonts.mono, color: EQ.attenue },
  depuis: { fontSize: 10, fontWeight: '500', color: EQ.attenue },
  dependant: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
  ...
  branche: { fontSize: 11, color: EQ.etiquette },
  dependantTexte: { flex: 1, gap: 1 },
  dependantNom: { fontSize: 11, fontWeight: '600', color: EQ.encre },
  dependantCoord: { fontSize: 9, fontWeight: '500', fontFamily: Fonts.mono, color: EQ.etiquette },
  dependantDroite: { alignItems: 'flex-end', gap: 4 },
  deplacer: { fontSize: 10, fontWeight: '700', color: EQ.vert },
  historique: { gap: 6, marginTop: 8, paddingTop: 8, borderTopWidth: 1, borderTopColor: EQ.separateur },
  historiqueTitre: { fontSize: 9, fontWeight: '700', letterSpacing: 0.5, color: EQ.attenue },
  historiqueLigne: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  puce: { width: 7, height: 7, borderRadius: 4, backgroundColor: EQ.vert },
  historiqueTexte: { fontSize: 10, fontWeight: '500', color: EQ.attenue },
  deplacerBouton: {
    height: 38,
    borderRadius: 10,
    borderWidth: 1,
  ...
  deplacerBoutonTexte: { fontSize: 11, fontWeight: '700', color: EQ.vert },
});
