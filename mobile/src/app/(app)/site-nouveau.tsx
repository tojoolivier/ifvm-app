...
const styles = StyleSheet.create({
  ...
  section: { marginBottom: -4, fontSize: 10, lineHeight: 12, fontWeight: '700', letterSpacing: 0.5, color: EQ.attenue },
  ...
  typeTitre: { fontSize: 13, lineHeight: 16, fontWeight: '700', color: EQ.attenue },
  typeDetail: { fontSize: 10, lineHeight: 12, fontWeight: '500', color: EQ.etiquette },
  equipe: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  equipeEtiquette: { fontSize: 11, lineHeight: 14, fontWeight: '600', color: EQ.vert },
  equipeNom: { fontSize: 12.5, lineHeight: 16, fontWeight: '700', color: EQ.encre },
  ...
  dependantTitre: { fontSize: 12.5, lineHeight: 16, fontWeight: '700', color: EQ.encre },
  dependantCorps: { gap: 8, paddingHorizontal: 12, paddingBottom: 12 },
  note: { padding: 8, borderRadius: 9, fontSize: 10.5, lineHeight: 13, fontWeight: '500', color: EQ.etiquette, backgroundColor: EQ.fond },
