...
function createStyles(typeSizes: ReturnType<typeof useTraitementTypeSizes>) {
  return StyleSheet.create({
    ...
    // Légèrement agrandi par rapport au reste de l'app (typeSizes.label,
    ...
    detailRowLabel: { fontFamily: traitementFonts.uiSemiBold, fontSize: typeSizes.corps - 1, color: traitementColors.texteLabel },
    detailRowValue: { fontFamily: traitementFonts.uiBold, fontSize: typeSizes.corps - 1, color: traitementColors.texteTitre },
