...
import { EquipeLocale, listEquipesDeUtilisateur } from '@/lib/referentiel-db';
 ...
 * oublie une équipe dont l'agent n'est plus membre : sans quoi les nouvelles saisies resteraient
