...
import { traitementColors, traitementFonts, traitementRadii, traitementSpacing, useTraitementTypeSizes } from './tokens';
import { useFormStyles } from './TraitementFormStyles';
...
function createStyles(typeSizes: ReturnType<typeof useTraitementTypeSizes>) {
  return StyleSheet.create({
    ...
    declencheurTexte: { flex: 1, fontFamily: traitementFonts.ui, fontSize: typeSizes.corps, color: traitementColors.texteTitre },
    placeholder: { color: traitementColors.texteLabel },
    chevron: { fontFamily: traitementFonts.ui, fontSize: typeSizes.corps, color: traitementColors.texteSecondaire, marginLeft: 8 },
    ...
    titre: { fontFamily: traitementFonts.uiSemiBold, fontSize: typeSizes.titreEcran, color: traitementColors.texteTitre },
    liste: { flexGrow: 0 },
    vide: { fontFamily: traitementFonts.ui, fontSize: typeSizes.corps, color: traitementColors.texteLabel, padding: 12 },
    ...
    ligneTexte: { fontFamily: traitementFonts.uiMedium, fontSize: typeSizes.corps, color: traitementColors.texteTitre },
    lien: { color: traitementColors.texteSecondaire, fontSize: typeSizes.corps, fontFamily: traitementFonts.uiSemiBold, textAlign: 'center', paddingVertical: 8 },
  });
}
