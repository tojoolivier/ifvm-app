 ...
 * Chaque rotation porte désormais quantité + unité (L/kg), une superficie traitée
 * et des heures d'ouverture/fermeture de vanne ; le numéro de cuve et les 3 durées
 * ne sont jamais saisis, seulement affichés.
 */
