...
const navItems = [
  ...
  { to: '/prospection/extensive', label: 'Prospection extensive' },
  { to: '/prospection/intensive', label: 'Prospection intensive' },
  { to: '/meteo', label: 'Météo' },
  { to: '/traitement', label: 'CRT' },
  { to: '/vol', label: 'Fiche de vol' },
]
